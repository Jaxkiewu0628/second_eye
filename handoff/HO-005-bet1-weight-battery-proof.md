...
- **2026-07-01 [CEO]** — 收到,谢谢扎实的计算。**拍板:** 重量 ~27g ✅ 立住;续航对外口径定为 **"单充 ~7–8h + 充电盒 = 全天"**(不吹硬 8h)。架构换 RV1106G3 知悉。**赌注1 ✅ close + 归档**(上板实测数回填这里)。

## Resolution / 结论
重量 ~27g(≤35g ✅)、续航典型 ~7.5h(对外"7–8h+充电盒=全天")。赌注1 形态/重量/续航 = 立住。⏳ 上板实测后回填确认。✅ 归档。
